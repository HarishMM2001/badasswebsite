  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <a class="left carousel-control _26sdfg" href="#myCarousel" data-slide="prev">
      <span class="glyphicon glyphicon-chevron-left"><i class="fa fa-arrow-circle-left"></i></span>
      <span class="sr-only" >Previous</span>
    </a>
    <a class="right carousel-control _26sdfg" href="#myCarousel" data-slide="next">
		
      <span class="glyphicon glyphicon-chevron-right"><i class="fa fa-arrow-circle-right"></i></span>
				...
				<div class="row">
					...
					<div class="col-md-4 col-xs-6">
						<a href="product.php?p=72"><div class="shop">
							...
							<div class="shop-body">
								<h3>WATCHES</h3>
								<a href="product.php?p=2" class="cta-btn">Shop now <i class="fa fa-arrow-circle-right"></i></a>
							</div>
						</div></a>
					</div>
					<!-- /shop -->
		...
		<div class="section">
			...
			<div class="container">
				...
				<div class="row">
						...
						<div class="section-title">
							...
							<div class="section-nav">
								<ul class="section-tab-nav tab-nav">
									...
									<li><a data-toggle="tab" href="#tab1">Kids</a></li>
					...
					$product_query = "SELECT * FROM products,categories WHERE product_cat=cat_id AND product_id BETWEEN 110 AND 130";
                        ...
                        echo "
								...
								<div class='product'>
									<a href='product.php?p=$pro_id'><div class='product-img'>
										<img src='product_images/$pro_image' style='max-height: 315px;' alt=''>
		...
		<div class="section">
			...
			<div class="container">
				...
				<div class="row">
					...
					$product_query = "SELECT * FROM products,categories WHERE product_cat=cat_id AND product_id BETWEEN 90 AND 125";
                $run_query = mysqli_query($con,$product_query);
                if(mysqli_num_rows($run_query) > 0){
